...
export class SpellList {
    constructor() {
        this.spells = [
            ...
            new Spell("Heightened Senses",
                ...
                "5+Range",
                "2+1R",
                "Increase the subject’s Acuity by 10 while the spell is active for the purposes of modeling having gained supernaturally sensitive senses. With Heightened Senses, a character has the eyes of an owl, ears of a hare, nose of hound, and can usually tell if there are creatures in the immediate vicinity. This spell must be maintained each time the subject spends or passes 10 AP."
            ),
            ...
            new Spell("Aid",
                ...
                "5+Range",
                "X",
                "Grants the subject +2X STR, DEX, or INT until they have spent or passed 20 AP. "
            ),
            new Spell("Blur",
                2,
                true,
                "5+Range",
                "1+1R",
                "Obfuscate all perception of the subject. Grant the subject +4 Defense. This spell must be maintained eacht time the subject spends or passes 10 AP."
            ),
            new Spell("Slow",
                3,
                false,
                "5+Range",
                "1-3",
                "It costs the subject +2*1-3 AP to Run until the subject has spent or passed 40 AP."
            ),
            ...
            new Spell("Confound",
                ...
                "5+Range",
                "X",
                "Subtract X from the subjects DEX or INT until the subject has spent or passed 20 AP."
            ),
            new Spell("Avert",
                3,
                true,
            ...
            new Spell("Wolf",
                ...
                "5",
                "2+1R",
                "Summon a wolf with 5 STR (2 Liberty), 7 DEX, 3 INT and 3 Natural Power with Finesse within STR hexes of the caster. Must be maintained every time it spends or passes 10 AP."
            ),
            new Spell("Fire",
                4,
                true,
            ...
            new Spell("Haste",
                ...
                "5",
                "X",
                "Reduce the cost of the subject’s movements actions by half until they’ve spent or passed X*20 AP."
            ),
            new Spell("Myrmidon",
                5,
                false,
                "5",
                "2+1R",
                "Summon a myrmidon with 6 STR, 6 DEX, 4 INT, and a power 6 Broadsword within STR hexes of the caster. Must be maintained every time it spends or passes 10 AP."
            ),
            new Spell("Dazzle",
                5,
                false,
                "5",
                "X",
                "Creates a blinding psychic flash. All sighted creatures (friend or foe) in an area within STR*X hexes of the mage (but NOT the mage himself) suffer -X DEX until they've spent or passed 30 AP."
            ),
            new Spell("Shadow",
                5,
                false,
            ...
            new Spell("Bear",
                ...
                "5",
                "4+1R",
                "Summon a bear with STR 15, DEX 5, INT 6, and 8 Natural power within STR hexes of the caster. Must be maintained every time it spends or passes 10 AP."
            ),
            new Spell("Illusion",
                5,
                true,
            ...
            new Spell ("Spook",
                ...
                "5+Range",
                "1+1R",
                "Lets the subject walk, run, climb, etc., totally noiselessly. +DEX Grace and Fitness to absorb a fall. This spell must be maintained each time the subject spends or passes 10 AP."
                ),
            new Spell ("Snake",
                5,
                true,
                "5",
                "4+1R",
                "Summon a snake with STR 2, DEX 7, INT 2, +2 Defense, and +4 Focus within STR hexes of the caster. The snake’s venom deals 1 power every time the victim spends or passes 5 AP until the victim has spent or passed power 2*10 AP. More venom does not increase the effect. Must be maintained every time it spends or passes 10 AP."
                ),
            new Spell ("Stasis",
                6,
                false,
            ...
            new Spell ("Invisibility",
                ...
                "5+Range",
                "3+1R",
                "Makes the subject invisible. Remove their counter from the game board and track their movements externally. Additionally, invisible figures are at +4 Defense (this does not stack with the effects of darkness or blur). This spell must be maintained each time the subject spends or passes 10 AP."
                ),
            new Spell ("Explode",
                4,
                false,
            ...
            new Spell ("Mage Sight",
                ...
                "5+Range",
                "2+1R",
                "Allows its subject to see objects concealed by blur, invisibility, shadow, or ordinary darkness. This spell must be maintained each time the subject spends or passes 10 AP."
                ),
            ...
            new Spell ("Eyes Behind",
                ...
                "5+Range",
                "2+1R",
                "The subject gains total awareness of their full periphery which expands into a full sphere of visual perception around them. Flanking a figure with Eyes Behind active upon it is impossible. This spell must be maintained each time the caster spends or passes 10 AP."
                ),
            new Spell ("Levitation",
                ...
                "5+Range",
                "3+1R",
                "Levitates the subject off the ground, granting them a limited ability to fly. An inexperienced flier (groundwalker) will be at -2 offense in melee, plus -2 offense to shoot or cast. A winged creature given the power of levitation will instead receive +2 DEX. All levitating figures have 2+Range defense and pay no additional costs to move up or down elevation or over difficult terrain. This spell must be maintained each time the caster spends or passes 10 AP."
                ),
            new Spell ("Gargoyle",
                6,
                true,
                "5",
                "4+1R",
                "Summons a levitating Gargoyle with 10 STR, 5 DEX, 4 INT, 6 Natural Power, 2 Natural Armor. Must be maintained every time it spends or passes 10 AP."
                ),
            ...
            new Spell ("Halt",
                ...
                "5+Range",
                "X",
                "Disallows the subject from taking any movement actions until they've spent or passed X*10 AP."
                ),
    ...
    sortByLevel() {
        this.spells.sort((a,b) => a.effectiveLevel - b.effectiveLevel)
    }
    ...
    get filteredSpells() {
        let searchText = this.spellFilter.toLowerCase();

        return this.spells.filter(spell => {
            let name = spell.name.toLowerCase();
            let effect = spell.effect.toLowerCase();
            return (name.includes(searchText) || effect.includes(searchText)) 
